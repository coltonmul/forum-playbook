...
return `<div class="card core-card"> <div class="corner-tl"></div> <div class="corner-br"></div> <div class="core-badge">CORE RESOURCE</div> <div class="core-icon-wrap">${icon}</div> <div class="card-title">${resource.title.toUpperCase()}</div> <div class="card-meta">${resource.subtitle}</div> <div class="card-btns">${buttons}</div> </div>`;
}
